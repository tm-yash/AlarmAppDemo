            ...
            <View
              ...
              <View>
                <View
                  ...
                  <Text style={{color: 'gray'}}>{item.timeDuretion}</Text>
                </View>
                <View>
    ...
    <SafeAreaView style={{flex: 1}}>
      <View style={styles.contener}>
        <View style={styles.Heading}>
          <View>
            <Text style={{fontSize: 40, fontWeight: '500'}}>Alarm</Text>
              ...
              <View style={{flexDirection:"row",justifyContent:"space-between" ,width:280}}>
                <View>
                  <TouchableOpacity style={styles.CancelBtn}>
                    <Text  style={{color:"#06122E",fontSize:18,fontWeight:"500"}}>Cancel</Text>
                  </TouchableOpacity>
                </View>
                <View>
                  <TouchableOpacity style={[styles.CancelBtn,{backgroundColor:"#212A35"}]}>
                    <Text style={{color:"#ffffff",fontSize:18,fontWeight:"500"}}>Save</Text>
                  </TouchableOpacity>
                </View>
              </View>
              <Pressable
                style={[styles.button, styles.buttonClose,{width:10,height:50}]}
